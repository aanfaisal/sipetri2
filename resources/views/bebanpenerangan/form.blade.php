<div class="form-group {{ $errors->has('nm_ruang') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        {!! Form::text('nm_ruang', null, ['class' => 'form-control']) !!}
...
<div class="form-group {{ $errors->has('jns_lamp') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        {!! Form::text('jns_lamp', null, ['class' => 'form-control']) !!}
...
<div class="form-group {{ $errors->has('jml_lamp') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        {!! Form::text('jml_lamp', null, ['class' => 'form-control']) !!}
...
<div class="form-group {{ $errors->has('daya_lamp') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        {!! Form::number('daya_lamp', null, ['class' => 'form-control']) !!}
...
<div class="form-group {{ $errors->has('tot_pemakaian') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        {!! Form::number('tot_pemakaian', null, ['class' => 'form-control']) !!}
...
<div class="form-group {{ $errors->has('wktu_pengukuran') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        {!! Form::input('datetime-local', 'wktu_pengukuran', null, ['class' => 'form-control']) !!}
...
<div class="form-group {{ $errors->has('tot_dayapen') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        {!! Form::number('tot_dayapen', null, ['class' => 'form-control']) !!}
